...
namespace TeleNet.Models.TL140
{
    ...
    public class TLMessage : TLAbsMessage
    {
        ...
        public TLVector<TL111.TLRestrictionReason> RestrictionReason { get; set; }
        ...
        public override void DeserializeBody(BinaryReader br)
        {
            ...
            if ((Flags & 4194304) != 0)
                RestrictionReason = (TLVector<TL111.TLRestrictionReason>)ObjectUtils.DeserializeVector<TL111.TLRestrictionReason>(br);
            else
