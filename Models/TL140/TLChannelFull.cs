...
namespace TeleNet.Models.TL140
{
    ...
    public class TLChannelFull : TLAbsChatFull
    {
        ...
        public TLAbsPeer DefaultSendAs { get; set; }
        ...
        public void ComputeFlags()
        {
            ...
            Flags = CanDeleteChannel ? (Flags | 1) : (Flags & ~1);
        ...
        public override void DeserializeBody(BinaryReader br)
        {
            ...
            if ((Flags & 536870912) != 0)
                DefaultSendAs = (TLAbsPeer)ObjectUtils.DeserializeObject(br);
            else
                DefaultSendAs = null;

            if ((Flags & 1073741824) != 0)
                AvailableReactions = ObjectUtils.DeserializeVector<string>(br);
            else
        ...
        public override void SerializeBody(BinaryWriter bw)
        {
            ...
            if ((Flags & 268435456) != 0)
                bw.Write(RequestsPending.Value);
            if ((Flags & 268435456) != 0)
                ObjectUtils.SerializeObject(RecentRequesters, bw);
            if ((Flags & 536870912) != 0)
                ObjectUtils.SerializeObject(DefaultSendAs, bw);
            if ((Flags & 1073741824) != 0)
