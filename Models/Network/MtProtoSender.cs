...
using TeleNet.Models.Requests;
using TeleNet.Models.Utils;

namespace TeleNet.Models.Network
{
    public class MtProtoSender
    {
        ...
        public async Task Send(TeleNet.Models.TLMethod request)
        {
            // TODO: refactor
        ...
        public async Task Send(byte[] packet, TeleNet.Models.TLMethod request)
        {
        ...
        public async Task<byte[]> Receive(TeleNet.Models.TLMethod request)
        {
        ...
        private bool processMessage(ulong messageId, int sequence, BinaryReader messageReader, TeleNet.Models.TLMethod request)
        {
            // TODO: check salt
        ...
        private bool HandleGzipPacked(ulong messageId, int sequence, BinaryReader messageReader, TeleNet.Models.TLMethod request)
        {
            uint code = messageReader.ReadUInt32();
        ...
        private bool HandleRpcResult(ulong messageId, int sequence, BinaryReader messageReader, TeleNet.Models.TLMethod request)
        {
            uint code = messageReader.ReadUInt32();
        ...
        private bool HandleBadServerSalt(ulong messageId, int sequence, BinaryReader messageReader, TeleNet.Models.TLMethod request)
        {
            uint code = messageReader.ReadUInt32();
        ...
        private bool HandlePong(ulong messageId, int sequence, BinaryReader messageReader, TeleNet.Models.TLMethod request)
        {
            uint code = messageReader.ReadUInt32();
        ...
        private bool HandleContainer(ulong messageId, int sequence, BinaryReader messageReader, TeleNet.Models.TLMethod request)
        {
            uint code = messageReader.ReadUInt32();
    ...
    public class FloodException : Exception
    {
        ...
        internal FloodException(TimeSpan timeToWait)
            : base($"Flood prevention. Telegram now requires your program to do requests again only after {timeToWait.TotalSeconds} seconds have passed ({nameof(TimeToWait)} property)." +
                    " If you think the culprit of this problem may lie in TeleNet's implementation, open a Github issue please.")
        {
